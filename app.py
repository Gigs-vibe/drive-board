...
class Api:
    ...
    def download_and_update(self, download_url):
        """Скачивает TaskaSetup.exe и запускает его тихо, выходя из job-объекта."""
        import subprocess
        ...
        # Убираем отметку «загружен из интернета» — иначе SmartScreen блокирует запуск
        try:
        ...
        # CREATE_BREAKAWAY_FROM_JOB выводит процесс из job-объекта PyInstaller,
        # чтобы он не умер вместе с нами при os._exit(0)
